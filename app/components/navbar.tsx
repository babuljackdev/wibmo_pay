    ...
    return (
        <nav>
            <ul className="space-y-2">
                ...
                <li>
                    <Link href="/payment" onClick={() => handleLinkClick('/payment')} className={`block py-2 px-4 rounded ${activeLink === '/payment' ? 'text-blue-600 bg-blue-100' : 'text-gray-700 hover:bg-gray-100'}`}>
                        Payment
                    </Link>
                </li>
                <li>
